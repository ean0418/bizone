...
//    public boolean addFavoriteLoanProduct(HttpServletRequest req, String productName, String loanLimit, String interestRate, String qualification, Principal principal) {
//        String userId = principal.getName();;
//
//        try {
//            HashMap<String, String> paramMap = new HashMap<>();
//            paramMap.put("bm_id", userId);
